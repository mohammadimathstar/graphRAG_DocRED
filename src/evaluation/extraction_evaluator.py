...
def build_entity_mappings(
    llm_doc: ExtractionDocument, gt_entities: List[Dict]
...
def extract_llm_triples(
    doc: ExtractionDocument, llm_to_gt: Dict[str, int]
...
def evaluate_document(
    gt_doc: Document, llm_doc: ExtractionDocument
) -> Dict[str, Metrics]:
    """
    ...
    gt_triple_idx = (
        gt_doc.triples_idx
    )  # Load directly as list of strings 'head_idx:relation_type:tail_idx'
